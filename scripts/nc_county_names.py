"""NC county FIPS -> name mapping. Source: U.S. Census Bureau 2024 county codes.

5-digit FIPS = first 2 digits state (37 = NC), last 3 digits county.
NC has 100 counties, all with odd-numbered county portions.
"""
NC_COUNTY_NAMES: dict[str, str] = {
